...
pub fn parse_remove_clause(input: &'_ str) -> IResult<&'_ str, RemoveClause<'_>, OpenCypherParsingError<'_>> {
...
fn remove_item_parser(input: &'_ str) -> IResult<&'_ str, PropertyAccess<'_>, OpenCypherParsingError<'_>> {
