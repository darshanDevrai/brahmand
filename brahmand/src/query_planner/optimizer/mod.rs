...
use crate::query_planner::{logical_plan::logical_plan::LogicalPlan, optimizer::{anchor_node_selection::AnchorNodeSelection, filter_push_down::FilterPushDown, optimizer_pass::{OptimizerPass, OptimizerResult}, projection_push_down::ProjectionPushDown}};
...
pub fn initial_optimization(plan: Arc<LogicalPlan>, plan_ctx: &mut PlanCtx) -> OptimizerResult<Arc<LogicalPlan>> {
...
pub fn final_optimization(plan: Arc<LogicalPlan>, plan_ctx: &mut PlanCtx) -> OptimizerResult<Arc<LogicalPlan>> {
